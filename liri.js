...
//   var screenName = {screen_name: 'ahmad'};
//   client.get('statuses/user_timeline', screenName, function(error, tweets, response){
//     if(!error){
//       for(var i = 0; i<tweets.length; i++){
//         var date = tweets[i].created_at;
//         console.log("@abd_aldayem: " + tweets[i].text + " Created At: " + date.substring(0, 19));
//         console.log("-----------------------");
        
//         //adds text to log.txt file
//         fs.appendFile('log.txt', "@abd_aldayem: " + tweets[i].text + " Created At: " + date.substring(0, 19));
